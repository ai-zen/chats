<template>
  <el-form-item prop="endpoint_config.azure_endpoint" label="azure_endpoint">
    <el-input
  ...
  <el-form-item prop="endpoint_config.api_version" label="api_version">
    <el-input
  ...
  <el-form-item prop="endpoint_config.deployments" label="deployments">
    <DeploymentsEditor
